...
This is the sourses for using and testing component tSmooksInput
...
Use tSmooksInput for: 
   - smooks transformation (EDI-to-TalendFlow)
   - multi-schema data output
   - triggered and Iterate connectors
